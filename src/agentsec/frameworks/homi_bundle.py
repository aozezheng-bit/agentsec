...
def render_homi_combined_report_html(
    ...
    substitutions = {
        ...
        "pilot_summary": _pilot_summary(pilot, chinese),
...
def _pilot_summary(pilot: dict[str, Any], chinese: bool) -> str:
    coverage = pilot.get("coverage_metrics")
    coverage = coverage if isinstance(coverage, dict) else {}
    ...
    return (
        ...
        "runtime attestation: not collected; acceptance ready: false.</p>"
    )

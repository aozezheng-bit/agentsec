...
```json
{
  ...
  "independence_statement": "本人独立完成全部 40 条 Case 评审，未查看 Reviewer A 的结果。",
...
不要提交整个 `reviewer-a/` 目录，也不要查看或合并 Reviewer A 的结果。

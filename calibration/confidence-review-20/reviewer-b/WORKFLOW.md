# P2-15A-QUAL-02 Confidence-only Review — reviewer-b

## Scope

You are reviewer-b. Review only the 20 opaque Cases in this directory.
...
no access to reviewer-a
```

## Independence declaration

```text
I independently completed the 20 Confidence-only Cases as reviewer-b;
I did not view reviewer-a, Ground Truth, Seed Labels, prior Confidence Evidence,

...
## Homi recalibration candidate status (2026-09-03)
...
P3-HOMI-RECAL-06  candidate complete: isolated, committed, reconciled, locally verified
Homi remote        paused: explicit install/试点 approval and remote fingerprint check pending
```

The candidate implementation produces `homi-build-fingerprint.json`,
...
runtime or release authority. The clean candidate branch and Release
